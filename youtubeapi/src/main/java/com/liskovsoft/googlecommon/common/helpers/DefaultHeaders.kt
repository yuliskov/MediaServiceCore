...
object DefaultHeaders {
    ...
    private const val ACCEPT_ENCODING_COMPRESSED_FAST = "gzip, deflate" // br uses 3x more RAM and has problems with ByeByeDPI
    ...
    const val ACCEPT_ENCODING = ACCEPT_ENCODING_COMPRESSED_FAST
