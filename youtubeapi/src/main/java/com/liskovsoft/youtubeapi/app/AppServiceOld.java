...
public class AppServiceOld {
    private static final String TAG = AppServiceOld.class.getSimpleName();
    private static AppServiceOld sInstance;
    ...
    private AppServiceOld() {
        mAppManager = RetrofitHelper.withRegExp(AppManager.class);
    }

    public static AppServiceOld instance() {
        if (sInstance == null) {
            sInstance = new AppServiceOld();
        }
    ...
    private String getPlayerUrl() {
        ...
        Call<AppInfo> wrapper = mAppManager.getAppInfo(AppConstants.USER_AGENT_LEGACY);
