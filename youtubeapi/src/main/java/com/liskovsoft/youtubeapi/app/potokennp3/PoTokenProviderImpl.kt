...
import com.liskovsoft.youtubeapi.app.potokennp3.misc.PoTokenProvider
import com.liskovsoft.youtubeapi.app.potokennp3.misc.PoTokenResult
...
import com.liskovsoft.youtubeapi.app.potokennp3.visitor.VisitorService
...
internal object PoTokenProviderImpl : PoTokenProvider {
        ...
        val (poTokenGenerator, visitorData, streamingPot, hasBeenRecreated) =
            synchronized(WebPoTokenGenLock) {
                ...
                if (shouldRecreate) {
                    ...
                    webPoTokenGenerator = PoTokenGeneratorImpl
    ...
    override val isWebPotExpired
        get() = isWebPotSupported && (webPoTokenGenerator?.isExpired() ?: true)

    override val isWebPotSupported
        get() = VERSION.SDK_INT >= 19 && webViewSupported && !webViewBadImpl
