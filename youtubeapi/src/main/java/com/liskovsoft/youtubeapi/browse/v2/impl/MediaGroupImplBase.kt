...
abstract class MediaGroupImplBase: MediaGroup {
    ...
    private val mediaItemList by lazy { getItemWrappersInt()?.mapIndexed { index, it -> it?.let { MediaItemImpl(it).apply { playlistIndex = index } } } }
