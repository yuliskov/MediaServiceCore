...
import com.liskovsoft.youtubeapi.formatbuilders.mpdbuilder.MPDParser;
...
public class YouTubeRssParser implements MPDParser {
    ...
    public YouTubeRssParser(InputStream mpdContent) {
        try {
