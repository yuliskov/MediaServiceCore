...
public class YouTubeMusicItem implements MusicItem {
    ...
    public static MusicItem from(com.liskovsoft.youtubeapi.common.models.videos.MusicItem item) {
        YouTubeMusicItem video = new YouTubeMusicItem();
        video.setId(id++);
