...
public class CaptionTrack {
    ...
    private static final String PARAM_VARIANT_DUB = "variant=timing-optimized";
    ...
    /**
     * Auto sub of the auto-dubbed audio<br/>
     * Useful when the response doesn't contain the dubbed audio (e.g. android_vr)
     */
    public boolean isDubTranscript() {
        return mBaseUrl != null && mBaseUrl.contains(PARAM_VARIANT_DUB);
    }
